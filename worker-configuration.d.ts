/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 716481a35ed8afe8b9c373216595ed66)
// Runtime types generated with workerd@1.20260630.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	ASSETS: Fetcher;
	OPENAI_API_KEY: string;
	CF_OAUTH_CLIENT_SECRET: string;
	USERAPP: DurableObjectNamespace<import("./src/worker").UserApp>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_API_KEY" | "CF_OAUTH_CLIENT_SECRET">> {}
}
